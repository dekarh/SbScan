...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_top1 = QtWidgets.QLabel(Form)
        self.label_top1.setObjectName("label_top1")
        self.verticalLayout_2.addWidget(self.label_top1)
        self.label_top2 = QtWidgets.QLabel(Form)
        self.label_top2.setObjectName("label_top2")
        self.verticalLayout_2.addWidget(self.label_top2)
        self.label_top3 = QtWidgets.QLabel(Form)
        self.label_top3.setObjectName("label_top3")
        self.verticalLayout_2.addWidget(self.label_top3)
        self.label_top4 = QtWidgets.QLabel(Form)
        self.label_top4.setObjectName("label_top4")
        self.verticalLayout_2.addWidget(self.label_top4)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_top1.setText(_translate("Form", "TextLabel"))
        self.label_top2.setText(_translate("Form", "TextLabel"))
        self.label_top3.setText(_translate("Form", "TextLabel"))
        self.label_top4.setText(_translate("Form", "TextLabel"))
