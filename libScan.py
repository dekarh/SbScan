...
propusk = ['aoзт', 'а', 'автономн%', 'администрац%', 'ао', 'ассоциац%', 'астрахан%',
           'бюро', 'в', 'г', 'групп', 'дом', 'дополнительн%', 'завод',
           'и', 'или', 'институ%', 'ип',
           'кировск%', 'комбинат', 'комитет', 'компан%', 'кондитерск%',
           'ленинск%', 'магазин', 'мастерск%', 'миграц%', 'многопрофильн%', 'муниципальн%',
           'на', 'научно-исследовательск%', 'некоммерческ%',
           'оао', 'област%', 'образован%', 'обществен%', 'общество', 'объединен%', 'ограниченной', 'оказан%', 'ооо',
           'организац%', 'от', 'ответственностью', 'отделен%',
           'пао', 'плюс', 'по', 'под', 'помощ%', 'поселок', 'предприят%', 'производствен%', 'профессиональн%',
           'рабочий', 'с', 'служб%', 'советск%', 'строительн%', 'субфилиал', 'торгов%', 'трусовск%',
           'фабрик%', 'фармацевтическ%', 'филиал', 'фирм%', 'центр', 'школ%']
